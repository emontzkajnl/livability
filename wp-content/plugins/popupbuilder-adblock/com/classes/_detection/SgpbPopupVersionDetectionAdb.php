...
class SgpbPopupVersionDetectionAdb
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_AD_BLOCK_JAVASCRIPT_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_AD_BLOCK_PUBLIC_URL.'/img/sgpbLogo.png',
			'header' => "<h2 style='font-size: 30px'>We had a major version update</h2>",
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_AD_BLOCK, true);
