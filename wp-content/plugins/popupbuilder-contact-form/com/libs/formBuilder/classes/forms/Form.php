...
abstract class Form
{
	...
	private function getFormFieldsFromSavedObj($savedObj)
	{
		...
		$fieldsHtml .= '<input type="hidden" name="sgpb-contact-hidden-checker" value="">';
	...
	public function createFieldObjByType($type)
	{
		...
		$fieldPath = SGPB_CF_FORM_CLASSES_FIELDS.'/'.$typeClassName.'.php';
	...
	public function getCurrentFieldsAdminHtmlTemplate()
	{
		...
		$iconHtml .= '<div class="sgpb-edit-settings sgpb-margin-left-10"><i class="sgpb-icons sgpb-cursor-pointer icons_blue" data-id="">C</i></div>';
