...
class SgpbPopupVersionDetectionContactForm
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_CONTACT_FORM_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_CONTACT_FORM_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_CONTACT_FORM, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_CONTACT_FORM_STORE_URL
		);
	}
