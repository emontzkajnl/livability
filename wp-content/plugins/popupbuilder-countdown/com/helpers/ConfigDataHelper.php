		...
		$data['countdownDateFormat'] = array(
			'template' => array(
				'fieldWrapperAttr' => array(
					'class' => 'sgpb-choice-option-wrapper sgpb-countdown-choice-option-wrapper'
				),
				'labelAttr' => array(
					'class' => 'formItem__title sgpb-margin-right-10 sgpb-choice-option-wrapper'
				),
			...
			'fields' => array(
				array(
					...
					'label' => array(
						...
						'info' => __('Use this option to set the countdown ending date.', SG_POPUP_TEXT_DOMAIN)
				...
				array(
					...
					'label' => array(
						...
						'info' => __('Use this option to set the exact time to countdown (in days, hours and minutes).', SG_POPUP_TEXT_DOMAIN)
					)
				)
			)
		);
