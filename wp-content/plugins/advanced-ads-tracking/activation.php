 ...
 * The "wxjr37odfssyfbroam25" part of the class name will be replaced by a random string.
 */
class advanced_ads_auto_activate_wxjr37odfssyfbroam25 {
	/**
	 ...
	 */
	const MAIN_FILE = 'tracking.php';

	/**
	 * Addon license option prefix
	 */
	const OPTION_SLUG = 'advanced-ads-tracking';

	/**
	 * Plugin name registered on the store
	 */
	const PLUGIN_NAME = 'Tracking';
...
new advanced_ads_auto_activate_wxjr37odfssyfbroam25();
