...
class LastnameField extends Field
{
	...
	{
		$this->setDisplayName('Last Name');
		$this->setType('lastname');
		$this->updateSettings();
	}
	...
	public function getFieldRequiredSettings($index)
	{
		...
		$settings['attrs']['name'] = 'sgpb-last-name'.$uniqueIndex;
	...
	{
		$html = parent::getGeneralEditSettingsRowsHtml('lastname');
		...
		$html .= '<div class="sgpb-onOffSwitch">
					<input type="checkbox" class="sgpb-onOffSwitch-checkbox sgpb-settings-field sgpb-settings-required" id="jsFormEnableRequired_lastname"  data-key="required" value="">
					<label class="sgpb-onOffSwitch__label" for="jsFormEnableRequired_lastname">
