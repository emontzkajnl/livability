...
class NumberField extends Field
{
	...
	public function getFieldRequiredSettings($index)
	{
		...
		$settings['attrs']['name'] = 'sgpb-number'.$uniqueIndex;
	...
	{
		$html = parent::getGeneralEditSettingsRowsHtml('number');
		...
		$html .= '<div class="sgpb-field-value col-md-6"><input type="text" data-key="placeholder" class="sgpb-settings-field sgpb-settings-placeholder sgpb-width-100" value=""></div>';
		$html .= '</div>';

		$html .= '<div class="sgpb-row-wrapper formItem">';
		$html .= '<label class="formItem__title">'.__('Required', SG_POPUP_TEXT_DOMAIN).'</label>';
		$html .= '<div class="sgpb-onOffSwitch">
					<input type="checkbox" class="sgpb-onOffSwitch-checkbox sgpb-settings-field sgpb-settings-required" id="jsFormEnableRequired_number"  data-key="required" value="">
					<label class="sgpb-onOffSwitch__label" for="jsFormEnableRequired_number">
