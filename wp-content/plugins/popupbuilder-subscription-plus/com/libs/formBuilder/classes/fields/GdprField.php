...
class GdprField extends Field
{
    ...
    public function getEditSettingsRowsHtml()
    {
        ...
        $html .= '<div class="sgpb-field-value"><input type="text" data-key="label" class="sgpb-settings-field sgpb-settings-label sgpb-width-100" value=""></div>';
        $html .= '</div>';
    ...
    public function getAfterFieldHtml()
    {
        ...
        $gdprDescription = '<div class="sgpb-subs-text-checkbox-gdpr" style="'.$infoDivInlineStyles.'">'.@$settings['gdprText'].'</div>';
