...
class SgpbPopupVersionDetectionSubscriptionPlus
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_SUBSCRIPTION_PLUS_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_SUBSCRIPTION_PLUS_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_SUBSCRIPTION_PLUS, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_SUBSCRIPTION_PLUS_STORE_URL
		);
	}
