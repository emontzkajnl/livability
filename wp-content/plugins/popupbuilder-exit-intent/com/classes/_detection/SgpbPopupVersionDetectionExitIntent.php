...
class SgpbPopupVersionDetectionExitIntent
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_EXIT_INTENT_JAVASCRIPT_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_EXIT_INTENT_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_EXIT_INTENT, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_EXIT_INTENT_STORE_URL
		);
	}
