...
class ExitIntentMain
{
	...
	public static function getInstance()
	{
		if(!isset(self::$instance)) {
			self::$instance = new ExitIntentMain();
		}
	...
	public function includeFiles()
	{
		...
		require_once(SGPB_EXIT_INTENT_VERSION_DETECTION_PATH.'SgpbPopupVersionDetectionExitIntent.php');
	}

	public function wpInit()
	{
		SGPBExitIntentConfig::addDefine('SG_VERSION_POPUP_EXIT_INTENT', '4.2');
		$this->actions = new Actions();
		new SgpbPopupVersionDetectionExitIntent();
	}
