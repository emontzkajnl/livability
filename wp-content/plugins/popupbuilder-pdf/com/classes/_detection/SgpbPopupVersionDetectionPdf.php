...
class SgpbPopupVersionDetectionPdf
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_PDF_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_PDF_PUBLIC_URL.'/img/sgpbLogo.png',
			'header' => "<h2 style='font-size: 30px'>We had a major version update</h2>",
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_PDF, true);
