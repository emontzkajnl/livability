...
class SgpbPopupVersionDetectionEdd
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_EDD_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_EDD_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_EDD, true);
