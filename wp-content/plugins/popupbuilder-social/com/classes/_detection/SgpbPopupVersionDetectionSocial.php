...
class SgpbPopupVersionDetectionSocial
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_SOCIAL_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_SOCIAL_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_SOCIAL, true);
