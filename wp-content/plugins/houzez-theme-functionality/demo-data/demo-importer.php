...
function Houzez_Import_Files() {
  return array(
    ...
    array(
      ...
      'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'houzez' ),
    ...
    array(
      'import_file_name'             => 'Houzez44',
      'import_file_url'            => 'https://plugins.houzez.co/demo-data/houzez44/content.xml',
      'import_widget_file_url'     => 'https://plugins.houzez.co/demo-data/houzez44/widgets.json',
      'import_customizer_file_url' => '',
      'import_redux'           => array(
        array(
          'file_url'   => 'https://plugins.houzez.co/demo-data/houzez44/theme-options.json',
          'option_name' => 'houzez_options',
        ),
      ),

      'import_preview_image_url'     => 'https://plugins.houzez.co/demo-data/houzez44/thumbnail.png',
      'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'houzez' ),
      'preview_url'                  => 'http://demo44.houzez.co',
    ),

    array(
      'import_file_name'             => 'Houzez45',
      'import_file_url'            => 'https://plugins.houzez.co/demo-data/houzez45/content.xml',
      'import_widget_file_url'     => 'https://plugins.houzez.co/demo-data/houzez45/widgets.json',
      'import_customizer_file_url' => '',
      'import_redux'           => array(
        array(
          'file_url'   => 'https://plugins.houzez.co/demo-data/houzez45/theme-options.json',
          'option_name' => 'houzez_options',
        ),
      ),

      'import_preview_image_url'     => 'https://plugins.houzez.co/demo-data/houzez45/thumbnail.png',
      'import_notice'                => __( 'After you import this demo, you will have to setup the slider separately.', 'houzez' ),
      'preview_url'                  => 'http://demo45.houzez.co',
    ),
...
function houzez_after_import_setup($selected_import) {
    ...
    if ( 'Houzez01' === $demo_name || 'Houzez02' === $demo_name || 'Houzez03' === $demo_name || 'Houzez04' === $demo_name || 'Houzez33' === $demo_name || 'Houzez33 - English' === $demo_name || 'Houzez34' === $demo_name || 'Houzez35' === $demo_name || 'Houzez36' === $demo_name || 'Houzez37' === $demo_name || 'Houzez38' === $demo_name || 'Houzez40' === $demo_name || 'Houzez41' === $demo_name || 'Houzez43' === $demo_name || 'Houzez44' === $demo_name || 'Houzez45' === $demo_name ) {
