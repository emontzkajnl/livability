...
- Fix: the ad setup page didn’t show up on new WooCommerce installations after WooCommerce changed post_type names
- Fix: prevent class property warning in PHP 8.2
- Fix: unify descriptions on the settings page

= 1.4.1 =

- Improvement: compatibility with the WP Global Cart plugin
- Fix: prevent a rare issue causing a fatal error with a custom add to cart link
- Fix: PHP notice on the order edit screen when an associated placement does not have an ad assigned
- Fix: correct the placement/group information in the "Publish" box

= 1.4.0 =

- Improvement: add Arabic, Danish, German (Austria, Switzerland), Greek, and Slovenian translations
- Improvement: update Italian, French, Dutch translations
- Improvement: wrap the setup-link text in a paragraph to allow styling
- Fix: correct the position of warnings on the Statistics page
- Fix: show the statistics link in the customer account for non-admins
