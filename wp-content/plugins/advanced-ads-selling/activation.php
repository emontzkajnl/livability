 ...
 * The "yxjlta2lhfi0og4f2kjy" part of the class name will be replaced by a random string.
 */
class advanced_ads_auto_activate_yxjlta2lhfi0og4f2kjy {
	/**
	 ...
	 */
	const MAIN_FILE = 'advanced-ads-selling.php';

	/**
	 * Addon license option prefix
	 */
	const OPTION_SLUG = 'advanced-ads-selling';

	/**
	 * Plugin name registered on the store
	 */
	const PLUGIN_NAME = 'Selling Ads';
...
new advanced_ads_auto_activate_yxjlta2lhfi0og4f2kjy();
