...
class SgpbPopupVersionDetectionAdvancedTargeting
{
	...
	{
		$jsFile = array('fileUrl' => SGPB_ADVANCED_TARGETING_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data   = array(
			...
			'logo'    => SGPB_ADVANCED_TARGETING_PUBLIC_URL.'/img/sgpbLogo.png',
			'url'     => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_ADVANCED_TARGETING, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url'            => SGPB_ADVANCED_TARGETING_STORE_URL
		);
	}
