...
class SgpbPopupVersionDetectionRecentSales
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_RECENT_SALES_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_RECENT_SALES_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_RECENT_SALES, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_RECENT_SALES_STORE_URL
		);
	}
