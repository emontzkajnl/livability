...
class SgpbPopupVersionDetectionRestriction
{
	...
	{
		$jsFile = array('fileUrl' => SGPB_RESTRICTION_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo'    => SGPB_RESTRICTION_PUBLIC_URL.'/img/sgpbLogo.png',
			'url'     => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_RESTRICTION, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url'            => SGPB_RESTRICTION_STORE_URL
		);
	}
