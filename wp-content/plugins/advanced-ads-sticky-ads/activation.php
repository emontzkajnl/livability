 ...
 * The "01tr9nwu0lmxnpq6emp8" part of the class name will be replaced by a random string.
 */
class advanced_ads_auto_activate_01tr9nwu0lmxnpq6emp8 {
	/**
	 ...
	 */
	const MAIN_FILE = 'sticky-ads.php';

	/**
	 * Addon license option prefix
	 */
	const OPTION_SLUG = 'advanced-ads-sticky';

	/**
	 * Plugin name registered on the store
	 */
	const PLUGIN_NAME = 'Sticky Ads';
...
new advanced_ads_auto_activate_01tr9nwu0lmxnpq6emp8();
