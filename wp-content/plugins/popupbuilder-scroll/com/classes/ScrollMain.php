...
class Scroll
{
	...
	public function includeFiles()
	{
		...
		require_once(SGPB_SCROLL_VERSION_DETECTION_PATH.'SgpbPopupVersionDetectionScroll.php');
	}

	public function wpInit()
	{
		SGPBScrollConfig::addDefine('SG_VERSION_POPUP_SCROLL', '3.3');
		$this->actions = new Actions();
		$this->filters = new Filters();
		new SgpbPopupVersionDetectionScroll();
	}
	...
	public function activate()
	{
		...
		$classPath = SGPB_SCROLL_DYNAMIC_CLASS_PATH.SGPB_SCROLL_EXTENSION_FILE_NAME;
