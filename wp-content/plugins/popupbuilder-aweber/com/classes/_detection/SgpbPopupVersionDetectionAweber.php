...
class SgpbPopupVersionDetectionAweber
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_AWEBER_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_AWEBER_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_AWEBER, true);
