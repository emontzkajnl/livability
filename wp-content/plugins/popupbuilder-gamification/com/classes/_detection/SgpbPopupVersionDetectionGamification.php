...
class SgpbPopupVersionDetectionGamification
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_GAMIFICATION_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_GAMIFICATION_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_GAMIFICATION, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_GAMIFICATION_STORE_URL
		);
	}
