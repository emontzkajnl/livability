 ...
 * The "ycvafbus7x6razbsungf" part of the class name will be replaced by a random string.
 */
class advanced_ads_auto_activate_ycvafbus7x6razbsungf {
	/**
	 ...
	 */
	const MAIN_FILE = 'layer-ads.php';

	/**
	 * Addon license option prefix
	 */
	const OPTION_SLUG = 'advanced-ads-layer';

	/**
	 * Plugin name registered on the store
	 */
	const PLUGIN_NAME = 'PopUp and Layer Ads';
...
new advanced_ads_auto_activate_ycvafbus7x6razbsungf();
