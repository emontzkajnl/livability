...
class SgpbPopupVersionDetectionInactivity
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_INACTIVITY_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_INACTIVITY_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_INACTIVITY, true);
