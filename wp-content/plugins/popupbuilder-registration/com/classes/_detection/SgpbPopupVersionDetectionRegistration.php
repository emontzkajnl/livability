...
class SgpbPopupVersionDetectionRegistration
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_REGISTRATION_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_REGISTRATION_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_REGISTRATION, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_REGISTRATION_STORE_URL
		);
	}
