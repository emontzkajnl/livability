...
class SgpbPopupVersionDetectionGeoTargeting
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_GEO_TARGETING_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_GEO_TARGETING_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_GEO_TARGETING, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_GEO_TARGETING_STORE_URL
		);
	}
