...
class SgpbPopupVersionDetectionAgeVerification
{
	...
	{
		$jsFile = array('fileUrl' => SGPB_AGE_VERIFICATION_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data   = array(
			...
			'logo'    => SGPB_AGE_VERIFICATION_PUBLIC_URL.'/img/sgpbLogo.png',
			'url'     => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_AGE_VERIFICATION, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url'            => SGPB_AGE_VERIFICATION_STORE_URL
		);
	}
