...
final class ECKey extends Sequence
{
    ...
    private function loadPEM($data)
    {
        ...
        $asnObject = SGPBPushObject::fromBinary($data);
    ...
    private function loadPKCS8(array $children)
    {
        ...
        $asnObject = SGPBPushObject::fromBinary($binary);
        Assertion::isInstanceOf($asnObject, Sequence::class);
    ...
    /**
     * @param \FG\ASN1\SGPBPushObject $children
     */
    private function verifyVersion(SGPBPushObject $children)
    {
     ...
     * @param string|null     $y
     */
    private function getXAndY(SGPBPushObject $children, &$x, &$y)
    {
     ...
     * @return string
     */
    private function getD(SGPBPushObject $children)
    {
