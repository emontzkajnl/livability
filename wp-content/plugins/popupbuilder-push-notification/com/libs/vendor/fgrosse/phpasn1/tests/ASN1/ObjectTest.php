...
class ObjectTest extends ASN1TestCase
{
    ...
    {
        $object = $this->getMockForAbstractClass('\FG\ASN1\SGPBPushObject');
    ...
    public function testFromBinary()
    {
        ...
        $parsedObject = SGPBPushObject::fromBinary($binaryData);
        ...
        $offsetIndex = 0;
        $parsedObject = SGPBPushObject::fromBinary($binaryData, $offsetIndex);
    ...
    public function testFromBinaryThrowsException()
    {
        $binaryData = 0x0;
        $offset = 10;
        SGPBPushObject::fromBinary($binaryData, $offset);
    }
    ...
    {
        $data = '';
        SGPBPushObject::fromBinary($data);
    }
    ...
    public function testFromBinaryInalidLongFormContentLength()
    {
        ...
        SGPBPushObject::fromBinary($binaryData);
    }
}
