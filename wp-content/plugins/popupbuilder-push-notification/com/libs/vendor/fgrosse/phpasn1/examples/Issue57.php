...
try {
    ...
    printObject(SGPBPushObject::fromBinary(base64_decode($input1)));
...
try {
    ...
    printObject(SGPBPushObject::fromBinary(base64_decode($input2)));
} catch (Exception $exception) {
    echo "ERROR: " . $exception->getMessage();
}
...
try {
    ...
    printObject(SGPBPushObject::fromBinary(base64_decode($input3)));
} catch (Exception $exception) {
    echo "ERROR: " . $exception->getMessage();
}
