...
abstract class Construct extends SGPBPushObject implements Countable, ArrayAccess, Iterator, Parsable
{
    /** @var \FG\ASN1\SGPBPushObject[] */
    protected $children;
    private $iteratorPosition;

    /**
     * @param \FG\ASN1\SGPBPushObject[] $children the variadic type hint is commented due to https://github.com/facebook/hhvm/issues/4858
     */
    ...
    public function addChild(SGPBPushObject $child)
    {
        $this->children[] = $child;
    }
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex = 0)
    {
        ...
        while ($octetsToRead > 0) {
            $newChild = SGPBPushObject::fromBinary($binaryData, $offsetIndex);
