...
class SgpbPopupVersionDetectionPushNotification
{
	public function canLoadView() {
	...
	{
		$jsFile = array('fileUrl'=> SGPB_PUSH_NOTIFICATION_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_PUSH_NOTIFICATION_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_PUSH_NOTIFICATION, true);
	...
	public static function popupBuilderFreeStableVersion()
	{
		return array(
			...
			'url' => SGPB_PUSH_NOTIFICATION_STORE_URL
		);
	}
