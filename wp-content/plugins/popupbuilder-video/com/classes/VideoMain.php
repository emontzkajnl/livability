...
class Video
{
	...
	public function includeFiles()
	{
		...
		require_once(SGPB_VIDEO_VERSION_DETECTION_PATH.'SgpbPopupVersionDetectionVideo.php');
	}

	public function wpInit()
	{
		SGPBVideoConfig::addDefine('SG_VERSION_POPUP_VIDEO', '2.2');
		$this->actions = new Actions();
		$this->filters = new Filters();
		new SgpbPopupVersionDetectionVideo();
	}
