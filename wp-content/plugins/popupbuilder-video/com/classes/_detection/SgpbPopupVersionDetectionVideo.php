...
class SgpbPopupVersionDetectionVideo
{
	...
	{
		$jsFile = array('fileUrl'=> SGPB_VIDEO_JS_URL.'/sgpbDetect.js', 'filename' => 'sgpbDetect.js');
		$data = array(
			...
			'logo' => SGPB_VIDEO_PUBLIC_URL.'/img/sgpbLogo.png',
			'url' => admin_url('plugins.php')
		);
		wp_register_script($jsFile['filename'], $jsFile['fileUrl'], '', SG_VERSION_POPUP_VIDEO, true);
