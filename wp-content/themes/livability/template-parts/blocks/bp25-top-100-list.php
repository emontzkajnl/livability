...
<div class="bp24__results">
    ...
    <div class="bp24__card">
        ...
        <a href="<?php echo get_the_permalink( $value->place_id).'?top-100=2025'; ?>">
        <?php echo get_the_post_thumbnail( $value->place_id, 'medium'); ?>k
        </a>
        </div>
        <div class="bp24__text-container">
        <a class="unstyle-link" href="<?php echo get_the_permalink( $value->place_id).'?top-100=2025';  ?>"><h4 class="bp24__city"><?php echo $value->city; ?></h4></a>
        ...
        <p class="bp24__read-more"><a class="unstyle-link" href="<?php echo get_the_permalink( $value->place_id).'?top-100=2025';  ?>">Read More</a></p>
        </div>
    </div>
    <?php } //end foreach ?>
</div>
