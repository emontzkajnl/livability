            ...
            <div class="wp-block-column">
                ...
                <div class="wp-block-columns liv-columns-2">
                   ...
                   <ul class="place-side-nav">
                       ...
                       <li><a href="brands-to-know"></a></li>
                       <li><a href="quick-facts"></a></li>
                       <li><a href="#weather"></a></li>
                       <li><a href="#map"></a></li>
                       <li><a href="#experiences-and-adventures"></a></li>
                       <li><a href="#food-scenes"></a></li>
                       <li><a href="#healthy-places"></a></li>
                       <li><a href="#make-your-move"></a></li>
                       <li><a href="#where-to-live-now"></a></li>
                       <li><a href="#education-careers-and-opportunities"></a></li>
                       <li><a href="#love-where-you-live"></a></li>
                       <li><a href="#more-about-living-in"></a></li>
