...
while ( have_posts() ) :
	...
	<?php echo do_shortcode( '[ajax_load_more single_post="true" single_post_id="'.get_the_ID().'" '.$place_rel_query.' single_post_order="previous" single_post_taxonomy="category"  repeater="template_1"  post_type="post" pause_override="true" loading_style="infinite classic" scroll_distance="100"]' );
