...
while ( have_posts() ) :
	...
	<?php get_template_part( 'template-parts/content/content-single-no-blocks', null, array('city' => $sponsored_ids, 'global' =>$sponsored_global_ids, 'state' => $sponsored_state_ids )); ?>
		...
		// }
?>
	<?php echo do_shortcode( '[ajax_load_more id="custom_single_query" single_post_taxonomy="category" single_post="true" single_post_id="'.get_the_ID().'"  single_post_order="previous" cache="true" cache_id="alm_1036248587" single_post_target="#article-wrapper"  post_type="post" pause_override="true" loading_style="infinite classic" scroll_distance="100"]' );
